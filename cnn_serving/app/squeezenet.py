...
# THe following needs pip install keras_applications - or add to the requirements.txt file
...
#from tensorflow.keras.utils import get_source_inputs,get_file, layer_utils
...
def SqueezeNet(include_top=True, weights='imagenet', no_top_weights_path = '/tmp/squeezenet_weights_tf_dim_ordering_tf_kernels.h5', 
    ...
    if weights == 'imagenet':
        if include_top:
            ...
            weights_path = no_top_weights_path
        else:
        ...
        if K.backend() == 'theano':
            ...
            print("theano backend is not supported in tf 2.7")
